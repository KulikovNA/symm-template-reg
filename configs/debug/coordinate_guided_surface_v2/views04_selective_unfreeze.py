"""Prepared fallback only; do not run without explicit fine-only analysis."""

_base_ = ["views04.py"]

experiment = dict(name="coordinate_guided_surface_v2_views04_selective_unfreeze")
stage = dict(
    name="FOUR_VIEW_coordinate_guided_surface_v2_selective_unfreeze",
    initialization="model_only_from_failed_four_view_fine_only_after_review",
