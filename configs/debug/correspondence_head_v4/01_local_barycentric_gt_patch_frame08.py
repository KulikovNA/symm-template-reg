_base_ = ["01_local_barycentric_gt_patch_frame04.py"]
experiment = dict(name="v4_local_barycentric_gt_patch_frame08")
...
stage = dict(name="local_barycentric_gt_patch_frame08")
