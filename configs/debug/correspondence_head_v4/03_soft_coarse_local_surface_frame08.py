_base_ = ["03_soft_coarse_local_surface_frame04.py"]
experiment = dict(name="v4_soft_coarse_local_surface_frame08")
...
stage = dict(name="soft_coarse_local_surface_frame08")
