_base_ = ["03_triangle_plus_barycentric_frame04.py"]
experiment = dict(name="v4_local_b3_triangle_plus_barycentric_frame08")
...
stage = dict(name="b3_triangle_plus_barycentric_frame08")
