_base_ = ["04_full_local_correspondence_frame04.py"]
experiment = dict(name="v4_local_b4_full_correspondence_frame08")
...
stage = dict(name="b4_full_local_correspondence_frame08")
