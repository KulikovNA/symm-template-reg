...
class ValidationAugmentationIsolationTest(unittest.TestCase):
    def test_validation_is_unaugmented(self):
        with tempfile.TemporaryDirectory() as temporary:
            ...
            self.assertFalse(dataset[0]["augmentation_metadata"]["augmentation_applied"])
